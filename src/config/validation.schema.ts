...
export const validationSchema = Joi.object({
  ...
  BAMPER_WINDSHIELD_URL: Joi.string().uri().default(BAMPER_DEFAULTS.WINDSHIELD_URL),
  BAMPER_REAR_LEFT_DOOR_MOLDING_URL: Joi.string()
    .uri()
    .default(BAMPER_DEFAULTS.REAR_LEFT_DOOR_MOLDING_URL),
