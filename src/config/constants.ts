...
export const BAMPER_DEFAULTS = {
   ...
   */
  // Car 1 — Atlas Cross Sport: rear bumper + tailgate + rear-left door molding (rear-end
  // damage) and windshield.
  REAR_BUMPER_URL:
  ...
  WINDSHIELD_URL:
    'https://bamper.by/zchbu/zapchast_steklo-lobovoe/marka_volkswagen/model_atlascrosssport/god_2023-2026/?sort=DATE-DESC',
  REAR_LEFT_DOOR_MOLDING_URL:
    'https://bamper.by/zchbu/zapchast_molding-dveri-zadney-levoy/marka_volkswagen/model_atlascrosssport/god_2023-2026/?sort=DATE-DESC',
